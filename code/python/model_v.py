...
class World():
	...
	def pymunk_setup(self,experiment):
		...
		self.add_wall(position = (790, 100), length = 20, height = 200, name = 'top_right_wall', space = self.space)
		self.add_wall(position = (790, 500), length = 20, height = 200, name = 'bottom_right_wall', space = self.space)
	...
	def simulate(self, experiment = '3ball', animate=True, trial=0, noise=0, save=False, info=[]):
		...
		while not done:
			if animate:
				...
				pygame.draw.rect(screen, pygame.color.THECOLORS['red'], [780,200,20,200]) #goal
				...
				pygame.draw.rect(screen, pygame.color.THECOLORS['black'], [780,0,20,200]) #top right
				pygame.draw.rect(screen, pygame.color.THECOLORS['black'], [780,400,20,200]) #bottom right
